...
<input class="w3-padding" name="username"  placeholder="Username" requiindigo></input>
<br>

<span class="w3-label">Password:</span>
<input class="w3-padding" type='password' name="password"  placeholder="Password" requiindigo></input>
<br>
