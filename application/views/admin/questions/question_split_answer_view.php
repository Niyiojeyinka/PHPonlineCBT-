...
<div class="w3-center">
<b class="w3-xlarge w3-text-blue-grey">Add New Split Answer:</b><br>
 <?php
echo form_open_multipart('admin_question/upload_split_answer');
?>
...
<span class="w3-label">Answer Year</span><br>
...
<input type="file" class="w3-padding" name="answer_file">
</div>
