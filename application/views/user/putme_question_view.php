<div id="q_div" class='w3-container'>
  <br>
  <div class="w3-center">
<span  class="w3-text-theme w3-large"><?= $_SESSION['school'] ?></span>
</div>
  <br>
  ...
  window.location.assign('<?php echo site_url('putme/submit'); ?>');
  }
  ...
  <?php echo form_open("putme/question_act"); ?>

<?php

 foreach($_SESSION['subjects'] as $key => $value)
{
$slug = 'putme/putme_s'.$key.'_question_page/';
 echo "<button class='w3-button w3-border' name='change_sub' value='".$slug."'>".$value."</button>";
