<div class="w3-container">
  ...
  <?php
   ...
   echo "<a class='w3-button w3-border' href='".site_url('question/corrections/s0_correction_page/').
"'>".$subject_items[0]."</a>";
echo "<a class='w3-button w3-border' href='".site_url('question/corrections/s1_correction_page/').
"'>".$subject_items[1]."</a>";
echo "<a class='w3-button w3-border' href='".site_url('question/corrections/s2_correction_page/').
"'>".$subject_items[2]."</a>";
echo "<a class='w3-button w3-border' href='".site_url('question/corrections/s3_correction_page/').
"'>".$subject_items[3]."</a>";
   ...
   echo '<br><span class="w3-large">B</span><input type="radio"
    ...
    echo '<br><span class="w3-large">C</span><input type="radio"
     ...
     echo '<br><span class="w3-large">D</span><input type="radio"
      ...
      $segment_slug = "s0_question_page";
      break;
      case 's1_correction_page':
      $segment_slug = "s1_question_page";
      break;
      case 's2_correction_page':
      $segment_slug = "s2_question_page";
      break;
      case 's3_correction_page':
      $segment_slug = "s3_question_page";
      break;
      }
...
$link = site_url('question/corrections/'.$this->uri->segment(3)."/".$i);
